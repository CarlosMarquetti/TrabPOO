...
public class DaoCliente{
    ...
    public void inserir(Cliente cliente){
        ...
        try {
            ps = conn.prepareStatement("INSERT INTO Vendedor(CPF, Nome, Endereco, Cidade, CEP, UF, TelefoneDDD, TelefoneNumero, LimiteCredito, LimiteDisponivel) VALUES(?,?,?,?,?,?,?,?,?,?)");
    ...
    public void alterar(Cliente cliente) {
     ...
     public Cliente consultar (String CPF) {
        ...
        try {
            ...
            if (rs.next() == true) {
                cliente = new Cliente (CPF, rs.getString("Nome"), rs.getDouble("SalarioBase"));
		cliente.setCep(rs.getString("CEP"));
		cliente.setCidade(rs.getString("Cidade"));
		cliente.setLimiteCred(rs.getDouble("LimiteCredito"));
		cliente.setLimiteDisp(rs.getDouble("LimiteDisponivel"));
